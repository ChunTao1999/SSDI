...
class AVS_config(object):
    ...
    # 2.6.2023 - tao88
    with_seg_masks              = True # whether or not to use seg masks in the target
    aligned_mask                = True
    with_glimpses               = False
    ...
    all_corrupt                 = False
    # 4.5.2023 - tao88: corruption configs (please only set zero or one type of corruption to True)
    ...
    puzzle_solving_all_permutations = False
    num_permute                 = 119
