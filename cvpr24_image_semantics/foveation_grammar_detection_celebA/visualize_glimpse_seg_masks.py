        ...
        if i == 0:
            for img_id in range(16):
                if not config_3.landmark_shuffle:
                    save_path = '/home/nano01/a/tao88/2.27/img_{}/different_foveation/correct'.format(img_id)
                else:
                    save_path = '/home/nano01/a/tao88/2.27/img_{}/different_foveation/corrupted'.format(img_id)
