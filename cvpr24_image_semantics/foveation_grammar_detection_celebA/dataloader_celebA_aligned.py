...
class CelebA_aligned(VisionDataset):
    ...
    def __init__(
        ...
        super(CelebA_aligned, self).__init__(root, transform=transform,
        ...
        # @Timur: added feature of selecting only certain attributes
        ...
        # @Timur: added feature of selecting only samples which has at least one of the selected attributes
        ...
        # @Timur: added feature to treat binary attribute targets as a decimal (integer) class labels
        self.treat_attributes_as_classes = treat_attributes_as_classes        
        
        # Chun: add landmark_shuffle
    ...
    def __getitem__(self, index: int):
        ...
        if target:
            ...
            if self.target_transform is not None: # Now it is none
                target = self.target_transform(target)
        else:
            target = None

        return index, X, target # X is a tensor, target contains only landmark
