...
--repeats 1 \
--eval_only \
--eval_path /home/nano01/a/tao88/cvpr24_image_semantics/PiCIE-CelebA/results/picie_on_celeba_finetuned_model_coarse/train/1/augmented/res1=256_res2=512/jitter=True_blur=True_grey=True/equiv/h_flip=True_v_flip=False_crop=True/min_scale\\=0.5/K_train=20_cosine/checkpoint_7.pth.tar \
--lr ${LR} \
--seed ${SEED} \
