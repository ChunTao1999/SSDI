...
save_path = './lstm_models_crop_masks_lr={}'.format(config_4.lr_start)
...
for epoch in range(0, config_3.epochs):
    ...
    for i, (indices, images, targets) in enumerate(train_loader):
        ...
        output_lstm, (hn, cn) = model_4(masks_extracted_resized, (h_0, c_0))
        loss_lstm = cosine_embedding_loss(output_lstm[:, :-1, :], mask_semantics_ratio[:, 1:, :]) #  both (128, 4, 7)
