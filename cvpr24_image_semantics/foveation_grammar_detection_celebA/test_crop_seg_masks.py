...
checkpoint  = torch.load(args.eval_path) # load from args.eval_path
model_FPN_epoch = checkpoint['epoch']
if config_3.data_parallel:
            ...
            for img_id in range(16):
                if not config_3.landmark_shuffle:
                    if not config_3.use_corrupted_testset:
                        save_path = '/home/nano01/a/tao88/3.15_fivepatch_model_{}/correct/img_{}'.format(model_FPN_epoch, img_id)
                    else:
                        save_path = '/home/nano01/a/tao88/3.15_fivepatch_model_{}/corrupted_testset/img_{}'.format(model_FPN_epoch, img_id)
                else:
                    save_path = '/home/nano01/a/tao88/3.15_fivepatch_model_{}/corrupted/img_{}'.format(model_FPN_epoch, img_id)
