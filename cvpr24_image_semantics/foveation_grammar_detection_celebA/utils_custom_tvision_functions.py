...
def get_dataloaders(config, loader_type='train'):
    ...
    if config.dataset.lower() == 'celeba':
        ...
        puzzle_solving_all_permutations = config.puzzle_solving_all_permutations
        ...
        if loader_type == 'train' or loader_type == 'trainval':
            transform = custom_Compose([transforms.Resize(size=config.full_res_img_size),
                        ...
                        transforms.ToTensor()])
            data    = CelebA_inthewild(config.dataset_dir, split = loader_type, target_type=target_type, 
                                    transform = transform, 
            ...
            data    = CelebA_inthewild(config.dataset_dir, 
                                       ...
                                       target_type=target_type, 
                                        ...
                                        puzzle_solving_all_permutations  = puzzle_solving_all_permutations,
