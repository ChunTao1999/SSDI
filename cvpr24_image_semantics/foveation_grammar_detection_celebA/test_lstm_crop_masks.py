...
with torch.no_grad():
    for i, (index, images, targets) in enumerate(valid_loader): # target_type=['attr', 'bbox', 'pred_init_glimpse_locs', 'landmarks', 'masks']
            ...
            for img_id in range(16):
                if not config_3.landmark_shuffle:
                    if not config_3.use_corrupted_testset:
                        save_path = '/home/nano01/a/tao88/3.23_fivepatch_masks/correct/img_{}'.format(img_id)
                    else:
                        save_path = '/home/nano01/a/tao88/3.23_fivepatch_masks/corrupted_testset/img_{}'.format(img_id)
                else:
                    save_path = '/home/nano01/a/tao88/3.23_fivepatch_masks/corrupted/img_{}'.format(img_id)
        ...
        output_lstm, (hn, cn) = model_4(batch_masks_flattened.float(), (h0, c0)) # (128, 5, 7)
        ...
        for sample_id in range(16):
            if not config_3.landmark_shuffle:
                if not config_3.use_corrupted_testset:
                    save_path = '/home/nano01/a/tao88/3.23_fivepatch_masks/correct/img_{}'.format(sample_id)
                else:
                    save_path = '/home/nano01/a/tao88/3.23_fivepatch_masks/corrupted_testset/img_{}'.format(sample_id)
            else:
                save_path = '/home/nano01/a/tao88/3.23_fivepatch_masks/corrupted/img_{}'.format(sample_id)
        ...
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.23_fivepatch_masks/curves_all.png')
        plt.close()
        ...
        plt.ylabel('L2 distance')
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.23_fivepatch_masks/curves_together_avg.png')    
        plt.close()
        ...
        plt.ylabel('L2 distance')
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.23_fivepatch_masks/curves_all_runavg.png')    
        plt.close()
        ...
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.23_fivepatch_masks/hist_distavg.png')
        plt.close()
