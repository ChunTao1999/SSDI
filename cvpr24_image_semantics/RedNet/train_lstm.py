...
save_path = './LSTM_models_trained_on_RedNet_generated_labels/num_classes=37/input_size=640x480/ps={}_bi-lstm_numlayers={}_startlr={}_epoch={}'.format(LSTM_config.patch_size, LSTM_config.num_layers, LSTM_config.lr_start, LSTM_config.epochs)
...
for epoch in range(0, LSTM_config.epochs):
    ...
    for batch_idx, sample in enumerate(train_loader):
        ...
        pred_labels = torch.max(pred, dim=1, keepdim=True)[1].float().to(device) # 37 classes, [0, 36]
