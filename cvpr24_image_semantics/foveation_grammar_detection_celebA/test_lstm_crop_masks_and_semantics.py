...
with torch.no_grad():
    for i, (index, images, targets) in enumerate(valid_loader): # target_type=['attr', 'bbox', 'pred_init_glimpse_locs', 'landmarks', 'masks']
            ...
            for img_id in range(16):
                if not config_3.landmark_shuffle:
                    if not config_3.use_corrupted_testset:
                        save_path = '/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/correct/img_{}'.format(img_id)
                    else:
                        save_path = '/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/corrupted_testset/img_{}'.format(img_id)
                else:
                    save_path = '/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/corrupted/img_{}'.format(img_id)
        ...
        for sample_id in range(16):
            if not config_3.landmark_shuffle:
                if not config_3.use_corrupted_testset:
                    save_path = '/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/correct/img_{}'.format(sample_id)
                else:
                    save_path = '/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/corrupted_testset/img_{}'.format(sample_id)
            else:
                save_path = '/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/corrupted/img_{}'.format(sample_id)
        ...
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/curves_all.png')
        plt.close()
        ...
        plt.ylabel('L2 distance')
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/curves_together_avg.png')    
        plt.close()
        ...
        plt.ylabel('L2 distance')
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/curves_all_runavg.png')    
        plt.close()

        # 3.23.2023 - tao88: plot a histogram for the average dist over all patches, for all images
        plt.figure()
        ...
        plt.legend()
        plt.savefig('/home/nano01/a/tao88/3.24_fivepatch_masks_and_semantics_maskpred_20epochs/hist_distavg.png')
        plt.close()

        # breakpoint after one batch
        pdb.set_trace()
